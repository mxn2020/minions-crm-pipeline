...
- `@minions-crm-pipeline/sdk` (npm package)
- `minions-crm-pipeline` (PyPI package)
- `@minions-crm-pipeline/cli` (npm package)
- The minions-crm-pipeline web playground
- The minions-crm-pipeline documentation site
