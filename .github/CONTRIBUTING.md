# Contributing to Minions Crm-pipeline

Thank you for your interest in contributing to Minions Crm-pipeline!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-crm-pipeline.git`
