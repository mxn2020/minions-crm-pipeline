...
/**
 * @minions-crm-pipeline/cli — CLI for Minions Crm-pipeline
 *
...
import { customTypes } from '@minions-crm-pipeline/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Crm-pipeline'));
        console.log(chalk.dim('Deal stages, transitions, revenue forecasts, and win/loss tracking'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-crm-pipeline/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-crm-pipeline/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-crm-pipeline')}`);
