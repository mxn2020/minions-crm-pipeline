# Manual Setup Steps for Minions Crm-pipeline
...
Go to **GitHub → mxn2020/minions-crm-pipeline → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-crm-pipeline` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-crm-pipeline-web`
- **GitHub repo**: `mxn2020/minions-crm-pipeline`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `crm-pipeline.minions.wtf`

### Documentation
- **Netlify site name**: `minions-crm-pipeline-docs`
- **GitHub repo**: `mxn2020/minions-crm-pipeline`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `crm-pipeline.minions.help`

### Blog
- **Netlify site name**: `minions-crm-pipeline-blog`
- **GitHub repo**: `mxn2020/minions-crm-pipeline`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `crm-pipeline.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `crm-pipeline.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `crm-pipeline.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `crm-pipeline.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-crm-pipeline/sdk`](https://www.npmjs.com/package/@minions-crm-pipeline/sdk)
- CLI: [`@minions-crm-pipeline/cli`](https://www.npmjs.com/package/@minions-crm-pipeline/cli)
...
Your package: [`minions-crm-pipeline`](https://pypi.org/project/minions-crm-pipeline/)
...
| Item | Value |
|------|-------|
| Project | `minions-crm-pipeline` |
| SDK (npm) | `@minions-crm-pipeline/sdk` |
| CLI (npm) | `@minions-crm-pipeline/cli` |
| Python (PyPI) | `minions-crm-pipeline` |
| GitHub | `github.com/mxn2020/minions-crm-pipeline` |
| Docs domain | `crm-pipeline.minions.help` |
| Blog domain | `crm-pipeline.minions.blog` |
| App domain | `crm-pipeline.minions.wtf` |
